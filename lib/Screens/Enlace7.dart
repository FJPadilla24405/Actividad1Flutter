              ...
              children: [
                ...
                const Row( 
                  ...
                  children: [
                    ...
                    Column(mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                      children: [ Text("1.026", style: TextStyle(fontWeight: FontWeight.bold)), Text("Publicaciones")],),
                    Column(mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                      children: [ Text("859", style: TextStyle(fontWeight: FontWeight.bold)), Text("Seguidores")],),
                    Column(mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                      children: [ Text("211", style: TextStyle(fontWeight: FontWeight.bold)), Text("Seguidos")],),
                  ],),
                ...
                const Row( 
                  ...
                  Padding(padding: EdgeInsets.all(10)),
                   Column(crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text("Ricardo Álvarez del Vayo", style: TextStyle(fontWeight: FontWeight.bold)),
                ...
                const Row(
                  ...
                  children: [
                    Column(mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                      children: [
                      CircleAvatar(radius: 35, backgroundImage: AssetImage('assets/images/Ricardo.png'),),
                      Text("Nuevo")],),
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    IconButton(onPressed: () {}, icon: const Icon(Icons.grid_on_outlined),
                    style: ElevatedButton.styleFrom(
                      foregroundColor: Colors.black,
                      backgroundColor: Colors.white,
